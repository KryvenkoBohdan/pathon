...
tutors = ['Иван', 'Анастасия', 'Петр', 'Сергей', 'Дмитрий', 'Борис', 'Елена', 'Марина', 'Вадим']
klasses = ['9А', '7В', '9Б', '9В', '8Б', '10А', '10Б', '9А']

if len(tutors) >= len(klasses):
    my_tuple_gen = (zip_longest(tutors, klasses))
else:
    print('Список "tutors" короче списка "klasses"')

print(*my_tuple_gen)
print(next(my_tuple_gen))
